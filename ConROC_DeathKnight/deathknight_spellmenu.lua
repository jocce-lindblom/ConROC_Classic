...
function ConROC:SpellmenuClass()
	...
	--Tank
		...
		local radio1text = frame:CreateFontString(radio1, "ARTWORK", "GameFontRedSmall");
			...
			radio1:SetChecked(ConROCDeathKnightSpells.ConROC_SM_Role_Tank);
			radio1:SetScript("OnClick",
				function()
					...
					ConROCDeathKnightSpells.ConROC_SM_Role_Tank = ConROC_SM_Role_Tank:GetChecked();
					ConROCDeathKnightSpells.ConROC_SM_Role_Melee = ConROC_SM_Role_Melee:GetChecked();
					ConROCDeathKnightSpells.ConROC_SM_Role_PvP = ConROC_SM_Role_PvP:GetChecked();
					ConROC:RoleProfile()
				end
			);
		...
		local r1t = radio1.texture;
			if not r1t then
				r1t = radio1:CreateTexture(nil, 'Spellmenu_radio1_Texture', 'ARTWORK');
	...
	--Melee
		...
		local radio2text = frame:CreateFontString(radio2, "ARTWORK", "GameFontRedSmall");
			...
			radio2:SetChecked(ConROCDeathKnightSpells.ConROC_SM_Role_Melee);
		...
		local r2t = radio2.texture;
			if not r2t then
				r2t = radio2:CreateTexture(nil, 'Spellmenu_radio2_Texture', 'ARTWORK');
	...
	--PvP
		...
		local radio4text = frame:CreateFontString(radio4, "ARTWORK", "GameFontRedSmall");
			...
			radio4:SetChecked(ConROCDeathKnightSpells.ConROC_SM_Role_PvP);
		...
		local r4t = radio4.texture;
			...
			if not r4t then
				r4t = radio4:CreateTexture(nil, 'Spellmenu_radio4_Texture', 'ARTWORK');
...
function ConROC:CheckFrame1()
	...
	--Battle Shout
		...
		local check1text = frame:CreateFontString(check1, "ARTWORK", "GameFontHighlightSmall");
			...
			if ConROC:CheckBox(ConROC_SM_Role_Tank) then
				check1:SetChecked(ConROCDeathKnightSpells.ConROC_Tank_Shout_BattleShout);
			elseif ConROC:CheckBox(ConROC_SM_Role_Melee) then
				check1:SetChecked(ConROCDeathKnightSpells.ConROC_Melee_Shout_BattleShout);
			elseif ConROC:CheckBox(ConROC_SM_Role_PvP) then
				check1:SetChecked(ConROCDeathKnightSpells.ConROC_PvP_Shout_BattleShout);
			end
			check1:SetScript("OnClick",
				function()
					if ConROC:CheckBox(ConROC_SM_Role_Tank) then
						ConROCDeathKnightSpells.ConROC_Tank_Shout_BattleShout = ConROC_SM_Shout_BattleShout:GetChecked();
					elseif ConROC:CheckBox(ConROC_SM_Role_Melee) then
						ConROCDeathKnightSpells.ConROC_Melee_Shout_BattleShout = ConROC_SM_Shout_BattleShout:GetChecked();
					elseif ConROC:CheckBox(ConROC_SM_Role_PvP) then
						ConROCDeathKnightSpells.ConROC_PvP_Shout_BattleShout = ConROC_SM_Shout_BattleShout:GetChecked();
					end
				end);
	...
	--Rend
		...
		local check2text = frame:CreateFontString(check2, "ARTWORK", "GameFontHighlightSmall");
			...
			check2:SetScale(.50);
			if ConROC:CheckBox(ConROC_SM_Role_Tank) then
				check2:SetChecked(ConROCDeathKnightSpells.ConROC_Tank_Debuff_Rend);
			elseif ConROC:CheckBox(ConROC_SM_Role_Melee) then
				check2:SetChecked(ConROCDeathKnightSpells.ConROC_Melee_Debuff_Rend);
			elseif ConROC:CheckBox(ConROC_SM_Role_PvP) then
