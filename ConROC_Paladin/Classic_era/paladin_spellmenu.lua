...
function ConROC:SpellmenuClass()
	...
	ConROC_RotationSettingsTable = {
	    ...
	    spells = {
	      ...
	      {spellID = ids.optionMaxIds.RetributionAura, spellCheckbox = "Aura_Retribution", reqLevel = 16, type="spell"},
	      {spellID = ids.optionMaxIds.ConcentrationAura, spellCheckbox = "Aura_Concentration", reqLevel = 22, type="spell"},
	      {spellID = ids.optionMaxIds.SanctityAura, spellCheckbox = "Aura_Sanctity", reqLevel = 30, type="spell"},
	  ...
	  },
	  {
	    ...
	    spells = {
	    	...
	    	{spellID = ids.optionMaxIds.BlessingofSalvation, spellCheckbox = "Bless_Salvation", reqLevel = 26, type="spell"},
	    	{spellID = ids.optionMaxIds.BlessingofSanctuary, spellCheckbox = "Bless_Sanctuary", reqLevel = 30, type="spell"},
	    	{spellID = ids.optionMaxIds.BlessingofLight, spellCheckbox = "Bless_Light", reqLevel = 40, type="spell"},
	    	{spellID = ids.optionMaxIds.GreaterBlessingofMight, spellCheckbox = "Bless_GreaterMight", reqLevel = 52, type="spell"},
	    	{spellID = ids.optionMaxIds.GreaterBlessingofWisdom, spellCheckbox = "Bless_GreaterWisdom", reqLevel = 54, type="spell"},
	    	{spellID = ids.optionMaxIds.GreaterBlessingofKings, spellCheckbox = "Bless_GreaterKings", reqLevel = 60, type="spell"},
			{spellID = ids.optionMaxIds.GreaterBlessingofSanctuary, spellCheckbox = "Bless_GreaterSanctuary", reqLevel = 60, type="spell"},
			{spellID = ids.optionMaxIds.GreaterBlessingofSalvation, spellCheckbox = "Bless_GreaterSalvation", reqLevel = 60, type="spell"},
	    },
	    groupType = "radioButtons"
	  },
	  {
