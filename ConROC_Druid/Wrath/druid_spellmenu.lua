	...
	ConROC_RotationSettingsTable = {
		{
			frameName = "AoEs",
			spells = {
				{spellID = ids.optionMaxIds.Starfall, spellCheckbox = "AoE_Starfall", reqLevel = 60, type="spell"},
				--{spellID = ids.optionMaxIds.Typhoon, spellCheckbox = "AoE_Typhoon", reqLevel = 60, type="spell"},
			},
		...
		},
		{
	    	frameName = "Options",
	    	spells = {
		    	{spellID = ids.optionMaxIds.Wrath, spellCheckbox = "Option_PrePull", reqLevel = 80, type="custom", icon=237511, customName="Use Prepull actions"},
