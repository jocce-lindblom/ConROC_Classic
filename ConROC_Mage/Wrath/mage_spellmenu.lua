...
function ConROC:SpellmenuClass()
	...
	ConROC_RotationSettingsTable = {
	    ...
	    spells = {
	      ...
	      {spellID = ids.optionMaxIds.MoltenArmor, spellCheckbox = "Armor_Molten", reqLevel = 62, type="spell"}
	    },
	  ...
	  },
	  {
	    ...
	    spells = {
	    	...
	    	{spellID = ids.optionMaxIds.IcyVeins, spellCheckbox = "CD_IcyVeins", reqLevel = 20, type="spell"},
	    	...
	    	{spellID = ids.optionMaxIds.MirrorImage, spellCheckbox = "CD_MirrorImage", reqLevel = 80, type="spell"}
	    },
	  ...
	  },
	  {
	    frameName = "Options",
	    spells = {
	    	{spellID = "Use Prepull actions", spellCheckbox = "Option_PrePull", reqLevel = 80, type="custom", icon=135994, customName="Use Prepull actions"},
