...
--Ranks
	...
	if IsSpellKnown(Fire_Ability.FireBlastRank9) then _FireBlast = Fire_Ability.FireBlastRank9;
	...
	if IsSpellKnown(Fire_Ability.FireWardRank6) then _FireWard = Fire_Ability.FireWardRank6;
	...
	if IsSpellKnown(Fire_Ability.FireballRank14) then _Fireball = Fire_Ability.FireballRank14;
	...
	if IsSpellKnown(Fire_Ability.FlamestrikeRank7) then _Flamestrike = Fire_Ability.FlamestrikeRank7;
	...
	if IsSpellKnown(Fire_Ability.PyroblastRank10) then _Pyroblast = Fire_Ability.PyroblastRank10;
	...
	if IsSpellKnown(Fire_Ability.ScorchRank9) then _Scorch = Fire_Ability.ScorchRank9;
	...
	if IsSpellKnown(Frost_Ability.BlizzardRank7) then _Blizzard = Frost_Ability.BlizzardRank7;
	...
	if IsSpellKnown(Frost_Ability.ConeofColdRank6) then _ConeofCold = Frost_Ability.ConeofColdRank6;
	...
	if IsSpellKnown(Frost_Ability.FrostboltRank14) then _Frostbolt = Frost_Ability.FrostboltRank14;
...
--Ranks
	...
	if IsSpellKnown(Frost_Ability.IceBarrierRank6) then _IceBarrier = Frost_Ability.IceBarrierRank6;
